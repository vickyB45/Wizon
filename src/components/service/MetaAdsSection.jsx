...
export default function MetaAdsSection() {
  return (
    <section className="flex flex-col max-w-6xl mx-auto items-center justify-center text-center md:py-8 md:px-6 px-2 bg-white">
      {/* Headline */}
      <motion.div
      ...
      >
        ...
        <div className="flex md:bg-none  justify-between flex-col-reverse items-center  w-full md:flex-row">
         <p className="relative text-start mt-6 text-xl py-8 md:py-0 md:text-2xl md:w-[60%] bg-center bg-cover bg-[url('/image/meta.png')] md:bg-none">
  <span className="absolute inset-0 bg-white/80 md:hidden"></span> {/* Background opacity layer */}
